...
if __name__ =='__main__':
    input, input_keypoints, input_descriptors=load_input()
    ...
    while (ret):
            ...
            if(matches!=None):
                output_final = cv2.drawMatchesKnn(input, input_keypoints,frame, output_keypoints, matches,None,flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
